...
Die Aufgabenstellung fordert die Verwendung von Java, C\# oder TypeScript, mindestens 8 sinnvoll integrierte GoF-Patterns,
Modularität und Erweiterbarkeit sowie UML-Dokumentation.
...
\midrule
Programmiersprache & Java 21~\cite{java21} \\
Build-System & Gradle 8.14 mit Wrapper~\cite{gradle} \\
...
Zusätzlich besitzt jede Fraktion einen passiven Bonus auf bestimmtem Gelände sowie einen Fraktionsvorteil (+25\,\% Schaden)
und einen Fraktionsnachteil ($-25$\,\% Schaden) gegenüber einer anderen Fraktion.
...
Das 10$\times$10-Spielfeld wird aus fünf Geländearten zusammengesetzt, die Bewegungskosten, Verteidigungsboni und
fraktionsspezifische Effekte besitzen. Diese sind in folgender Tabelle dargestellt.
...
Jede Einheit kann pro Runde maximal zwei Aktionen ausführen. Einheiten können sich Bewegen und Angreifen.
Die Bewegungen kosten je nach Gelände und Fraktion unterschiedlich viele Bewegungspunkte. Fliegende Einheiten (Luft-Fraktion
sowie der Phönix) ignorieren Geländekosten.
Die Angriffe unterscheiden sich in Nahkampf (Reichweite~1) und Fernkampf (Reichweite~2--4), wobei das Wald-Gelände die
Sichtlinie für Fernkämpfer blockieren kann.
Die Geländeeffekte werden über das Visitor Pattern fraktionsspezifisch berechnet. Die Fraktionsboni und -mali über die
Chain of Responsibility in die Schadensberechnung integriert.
Mit steigender Rundenzahl können zufällige (De-)Buffs auf Einheiten angewendet werden, die über das Decorator Pattern
gestapelt werden.
Alle Aktionen einer Runde sind per Undo/Redo zurücknehmbar (Command Pattern).
