...
F2 & Einheiten & Verschiedene Einheitentypen, die sich bewegen und handeln können. Umgesetzt als 4 Fraktionen (Feuer, Wasser, Erde, Luft) mit je 3 Einheitentypen und individuellen Werten für LP, Angriff, Verteidigung, Bewegung und Reichweite. \\
...
ElementarClash ist ein rundenbasiertes Strategiespiel, in dem zwei Spieler jeweils eine elementare Fraktion steuern.\footnote{Die Architektur des \texttt{GameBuilder} unterstützt 2--4 Fraktionen; die aktuelle Spieloberfläche ist jedoch auf zwei Spieler ausgelegt.}
