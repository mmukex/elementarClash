...
für jede Granularitätsstufe eigene Methoden benötigt hätten. Zusätzlich bietet \texttt{Battlefield} die Methode \texttt{getRegion(x1, y1, x2, y2)},
...
einem LP-pro-Runde-Effekt sowie einer optionalen Geländetransformation (z.\,B. Eis →\rightarrow
→ Wüste bei Feuer-Einheiten). Der \texttt{Unit.accept(TerrainVisitor)} realisiert den Double Dispatch über einen \texttt{switch}
