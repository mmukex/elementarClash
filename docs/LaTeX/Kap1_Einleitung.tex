...
Diese schriftliche Ausarbeitung wurde begleitend zum Projekt \textit{ElementarClahs} von Max Meier und Christian Stiens für das Fach \textit{Design Pattern in der OOP} erstellt.
Ziel der Entwicklung von \textit{ElementarClash} war die praktische Anwendung von Design Pattern nach GoF.
...
Diese Terrains wiederum können sich positiv oder negativ auf die Spielfiguren auswirken.
